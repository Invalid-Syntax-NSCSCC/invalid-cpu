...
object Inst {
  ...
  object _3R {
    ...
    val invtlb  = i("0000_0110_0100_1001_1")
    ...
    val idle    = i("0000_0110_0100_1000_1")
  }
  ...
  object _special {
    ...
    val ertn      = i("0000_0110_0100_1000_0011_1000_0000_0000", 32, 7)

    val tlbsrch = i("0000_0110_0100_1000_0010_1000_0000_0000", 32, 7)
    val tlbrd   = i("0000_0110_0100_1000_0010_1100_0000_0000", 32, 7)
    val tlbwr   = i("0000_0110_0100_1000_0011_0000_0000_0000", 32, 7)
    val tlbfill = i("0000_0110_0100_1000_0011_0100_0000_0000", 32, 7)
  }
}
